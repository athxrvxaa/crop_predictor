...
# RULES = {
#     'Gram': {
#         'sow_months': [9,10,11,12,1],
#         'harv_months': [1,2,3,4,5],
#         'min_dur': 70, 'max_dur': 180,
#         'min_drop': 0.10, 'min_rise': 0.10
#     },
...
#     'Maize': {
#         'sow_months': [4,5,6,7,8,9,10,11],
#         'harv_months': [7,8,9,10,11,12,1,2],
#         'min_dur': 60, 'max_dur': 180,
#         'min_drop': 0.12, 'min_rise': 0.12
#     },

#     'Mustard': {
#         'sow_months': [8,9,10,11,12],
#         'harv_months': [1,2,3,4],
#         'min_dur': 70, 'max_dur': 180,
#         'min_drop': 0.10, 'min_rise': 0.10
#     },
...
#     'Potato': {
#         'sow_months': [9,10,11,12,1,2],
#         'harv_months': [1,2,3,4,5],
#         'min_dur': 60, 'max_dur': 150,
#         'min_drop': 0.10, 'min_rise': 0.10
#     },

#     'Rice': {
#         'sow_months': [4,5,6,7,8],
#         'harv_months': [8,9,10,11,12,1],
#         'min_dur': 70, 'max_dur': 210,
#         'min_drop': 0.12, 'min_rise': 0.12
#     },

#     'Wheat': {
#         'sow_months': [9,10,11,12,1],
#         'harv_months': [2,3,4,5,6],
#         'min_dur': 80, 'max_dur': 200,
#         'min_drop': 0.10, 'min_rise': 0.10
#     },

#     'Sugarcane': {
#         'sow_months': list(range(1,13)),
#         'harv_months': list(range(1,13)),
#         'min_dur': 120, 'max_dur': 500,
#         'min_drop': 0.03, 'min_rise': 0.03
#     },

#     'Banana': {
#         'sow_months': list(range(1,13)),
#         'harv_months': list(range(1,13)),
#         'min_dur': 150, 'max_dur': 500,
#         'min_drop': 0.03, 'min_rise': 0.03
#     },
...
#         'sow_months': list(range(1,13)),
#         'harv_months': list(range(1,13)),
#         'min_dur': 45, 'max_dur': 150,
#         'min_drop': 0.08, 'min_rise': 0.08
#     },
...
#     'Soybean': {
#         'sow_months': [5,6,7,8],
#         'harv_months': [8,9,10,11,12],
#         'min_dur': 70, 'max_dur': 180,
#         'min_drop': 0.12, 'min_rise': 0.12
#     },

#     'Cotton': {
#         'sow_months': [4,5,6,7,8,9],
#         'harv_months': [10,11,12,1,2,3,4],
#         'min_dur': 60, 'max_dur': 280,
#         'min_drop': 0.08, 'min_rise': 0.06
#     },

#     'Jowar': {
#         'sow_months': [5,6,7,8,9,10,11],
#         'harv_months': [8,9,10,11,12,1,2,3],
#         'min_dur': 70, 'max_dur': 180,
#         'min_drop': 0.10, 'min_rise': 0.10
#     },
...
#     'Bajra': {
#         'sow_months': [5,6,7,8],
#         'harv_months': [8,9,10,11],
#         'min_dur': 60, 'max_dur': 150,
#         'min_drop': 0.10, 'min_rise': 0.10
#     },

#     'Tur': {
#         'sow_months': [5,6,7,8,9],
#         'harv_months': [11,12,1,2,3,4],
#         'min_dur': 120, 'max_dur': 320,
#         'min_drop': 0.10, 'min_rise': 0.10
#     },

#     'Turmeric': {
#         'sow_months': [4,5,6,7,8],
#         'harv_months': [12,1,2,3,4,5],
#         'min_dur': 150, 'max_dur': 350,
#         'min_drop': 0.03, 'min_rise': 0.03
#     },
...
#         'sow_months': list(range(1,13)),
#         'harv_months': list(range(1,13)),
#         'min_dur': 90, 'max_dur': 450,
#         'min_drop': 0.03, 'min_rise': 0.03
#     },

#     'Safflower': {
#         'sow_months': [9,10,11,12],
#         'harv_months': [2,3,4,5],
#         'min_dur': 80, 'max_dur': 200,
#         'min_drop': 0.10, 'min_rise': 0.10
#     },
